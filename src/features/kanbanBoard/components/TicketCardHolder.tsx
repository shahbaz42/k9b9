        ...
        {addingTicket && (
          <div className="ticket-card ">
            <div className="hz-input-group">
              ...
              <input className="input-comp disabled" value={id} disabled type="text" />
            </div>
            <div className="hz-input-group mt-2">
              <label className="text-smaller text-semibold">Title</label>
              <input className="input-comp" value={title} onChange={(e)=>{setTitle(e.target.value)}} type="text" />
            </div>
            <div className="hz-input-group mt-2">
              <label className="text-smaller text-semibold">Tag</label>
              <input className="input-comp" value={tag} onChange={(e)=>{setTag(e.target.value)}} type="text" />
            </div>
            <div className="hz-input-group mt-2">
              <label className="text-smaller text-semibold">Assign To</label>
              <select value={userId} onChange={(e) => { setUserId(e.target.value) }} className="input-comp px-2" style={{width: 210}}>
            ...
            <div className="hz-input-group mt-2">
              ...
              <select value={status} onChange={(e) => { setStatus(e.target.value) }} className="input-comp px-2" style={{width: 210}}>
            ...
            <div className="hz-input-group mt-2">
              ...
              <select value={priority} onChange={(e) => { setPriority(parseInt(e.target.value)) }} className="input-comp px-2" style={{width: 210}}>
            ...
            <div className="btn-left-wrapper mt-2">
              <button className="create_button" onClick={()=>{createTicket()}}>Create</button>
            </div>
          </div>
        )}
